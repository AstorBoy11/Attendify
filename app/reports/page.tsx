          ...
          <div className="w-full max-w-300 mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col flex-1">
                ...
                <div className="flex flex-wrap items-end gap-3 bg-[#1c2127] p-4 rounded-xl border border-[#3b4754] shadow-sm">
                  <div className="flex flex-col min-w-35">
                    ...
                    <div className="relative">
                      <select className="w-full appearance-none rounded-lg border border-[#3b4754] bg-[#111418] text-white py-2.5 px-3 pr-10 text-sm focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary">
              ...
              <div className="flex flex-col bg-[#1c2127] rounded-xl border border-[#3b4754] shadow-sm overflow-hidden flex-1">
                ...
                <div className="px-6 py-4 border-b border-[#3b4754] flex justify-between items-center bg-[#20262e]">
                  <h3 className="text-white font-bold text-lg">October 2023 Attendance</h3>
                  <div className="flex gap-2">
                    <button className="text-[#9dabb9] hover:text-primary p-2 rounded hover:bg-[#2d3642] transition-colors" title="Download PDF">
                      <span className="material-symbols-outlined">picture_as_pdf</span>
                    </button>
                    <button className="text-[#9dabb9] hover:text-primary p-2 rounded hover:bg-[#2d3642] transition-colors" title="Export CSV">
                  ...
                  <table className="w-full text-left border-collapse">
                    <thead className="bg-[#252b33] sticky top-0 z-10">
                      <tr>
                        ...
                        <th className="py-3 px-6 text-xs font-semibold text-[#9dabb9] uppercase tracking-wider border-b border-[#3b4754]">Breaks</th>
                    ...
                    <tbody className="divide-y divide-[#2d3642]">
                      {/* Row 1 */}
                      <tr className="hover:bg-[#232930] transition-colors group">
                        <td className="py-4 px-6 text-sm font-medium text-white">
                          <div className="flex flex-col">
                            <span>Oct 01</span>
                            <span className="text-xs text-[#9dabb9] font-normal">Monday</span>
                          </div>
                        </td>
                        <td className="py-4 px-6 text-sm text-[#cfd8e3] font-mono">08:58 AM</td>
                        <td className="py-4 px-6 text-sm text-[#cfd8e3] font-mono">05:05 PM</td>
                        <td className="py-4 px-6 text-sm text-[#9dabb9]">45 min</td>
                        <td className="py-4 px-6 text-sm font-bold text-white text-right font-mono">8h 07m</td>
                      ...
                      <tr className="hover:bg-[#232930] transition-colors group">
                        <td className="py-4 px-6 text-sm font-medium text-white">
                          <div className="flex flex-col">
                            <span>Oct 02</span>
                            <span className="text-xs text-[#9dabb9] font-normal">Tuesday</span>
                          </div>
                        </td>
                        <td className="py-4 px-6 text-sm text-[#cfd8e3] font-mono">09:15 AM</td>
                        <td className="py-4 px-6 text-sm text-[#cfd8e3] font-mono">06:15 PM</td>
                        <td className="py-4 px-6 text-sm text-[#9dabb9]">45 min</td>
                        <td className="py-4 px-6 text-sm font-bold text-white text-right font-mono">8h 15m</td>
                        <td className="py-4 px-6 text-center">
                      ...
                      <tr className="hover:bg-[#232930] transition-colors group">
                        <td className="py-4 px-6 text-sm font-medium text-white">
                          <div className="flex flex-col">
                            <span>Oct 03</span>
                            <span className="text-xs text-[#9dabb9] font-normal">Wednesday</span>
                          </div>
                        </td>
                        <td className="py-4 px-6 text-sm text-[#cfd8e3] font-mono">08:50 AM</td>
                        <td className="py-4 px-6 text-sm text-[#cfd8e3] font-mono">05:00 PM</td>
                        <td className="py-4 px-6 text-sm text-[#9dabb9]">45 min</td>
                        <td className="py-4 px-6 text-sm font-bold text-white text-right font-mono">8h 10m</td>
                        <td className="py-4 px-6 text-center">
                          <span className="inline-flex items-center gap-1.5 rounded-full bg-green-500/10 px-2.5 py-1 text-xs font-medium text-green-400 border border-green-500/20">
                            <span className="w-1.5 h-1.5 rounded-full bg-green-500"></span>
                            Valid
                      ...
                      <tr className="hover:bg-[#232930] transition-colors group">
                        <td className="py-4 px-6 text-sm font-medium text-white">
                          <div className="flex flex-col">
                            <span>Oct 04</span>
                            <span className="text-xs text-[#9dabb9] font-normal">Thursday</span>
                          </div>
                        </td>
                        <td className="py-4 px-6 text-sm text-[#cfd8e3] font-mono">09:00 AM</td>
                        <td className="py-4 px-6 text-sm text-[#cfd8e3] font-mono">05:30 PM</td>
                        <td className="py-4 px-6 text-sm text-[#9dabb9]">60 min</td>
                        <td className="py-4 px-6 text-sm font-bold text-white text-right font-mono">7h 30m</td>
                        <td className="py-4 px-6 text-center">
                      ...
                      <tr className="hover:bg-[#232930] transition-colors group">
                        <td className="py-4 px-6 text-sm font-medium text-white">
                          <div className="flex flex-col">
                            <span>Oct 05</span>
                            <span className="text-xs text-[#9dabb9] font-normal">Friday</span>
                          </div>
                        </td>
                        <td className="py-4 px-6 text-sm text-[#cfd8e3] font-mono">08:45 AM</td>
                        <td className="py-4 px-6 text-sm text-[#cfd8e3] font-mono">04:45 PM</td>
                        <td className="py-4 px-6 text-sm text-[#9dabb9]">45 min</td>
                        <td className="py-4 px-6 text-sm font-bold text-white text-right font-mono">8h 00m</td>
                        <td className="py-4 px-6 text-center">
                          <span className="inline-flex items-center gap-1.5 rounded-full bg-green-500/10 px-2.5 py-1 text-xs font-medium text-green-400 border border-green-500/20">
                            <span className="w-1.5 h-1.5 rounded-full bg-green-500"></span>
                            Valid
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                    <div className="flex flex-wrap justify-center md:justify-start gap-8 md:gap-12 w-full md:w-auto">
                      <div className="flex flex-col items-center md:items-start gap-1">
                        <p className="text-[#9dabb9] text-xs font-semibold uppercase tracking-wider">Total Realization</p>
                        <p className="text-white text-2xl font-black">165h <span className="text-lg font-medium text-[#9dabb9]">15m</span></p>
                      </div>
                      <div className="w-px h-12 bg-[#3b4754] hidden md:block"></div>
                      <div className="flex flex-col items-center md:items-start gap-1">
                        <p className="text-[#9dabb9] text-xs font-semibold uppercase tracking-wider">Monthly Target</p>
                        <p className="text-white text-2xl font-black">160h <span className="text-lg font-medium text-[#9dabb9]">00m</span></p>
                      </div>
                      <div className="w-px h-12 bg-[#3b4754] hidden md:block"></div>
                      <div className="flex flex-col items-center md:items-start gap-1">
                        <p className="text-[#9dabb9] text-xs font-semibold uppercase tracking-wider">Remaining</p>
                        <p className="text-emerald-400 text-2xl font-black">+5h <span className="text-lg font-medium opacity-80">15m</span></p>
                      </div>
                    </div>
                    {/* Achievement Badge */}
                    <div className="flex items-center gap-3 bg-[#283039] py-3 px-5 rounded-lg border border-[#3b4754] shadow-sm">
                      ...
                      <div className="flex flex-col">
                        <span className="text-white text-sm font-bold">Target Reached</span>
                        <span className="text-[#9dabb9] text-xs">103% Completion</span>
                      </div>
                    </div>
                  </div>
                  {/* Progress Bar */}
